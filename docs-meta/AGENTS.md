# Arrow.js Docs-Meta — Agent Guide
...
```sh
pnpm dev:meta          # Start dev server on http://127.0.0.1:4174
pnpm build:meta        # Build client + SSR bundles
pnpm preview:meta      # Preview production build
```
